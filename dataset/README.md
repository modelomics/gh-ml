...
Selector v5 routes exploration or comparison of named existing time-series models to review, even when a repository name says “novel model.” A direct novelty claim with an active README coursework signal also stays in review when the active README has a coursework cue without a paper reference or official/paper-code signal; a paper reference is provenance, not proof of officiality or novelty.
